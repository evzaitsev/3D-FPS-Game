...
ID3D11DepthStencilState*      RenderStates::DisableDepthDDS = 0;
...
void RenderStates::InitAll(ID3D11Device* device)
{
	...
	HR(device->CreateDepthStencilState(&depthDisabledStencilDesc, &DisableDepthDDS));
}

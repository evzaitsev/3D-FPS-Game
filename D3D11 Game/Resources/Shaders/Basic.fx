...
float4 PS(VertexOut pin, 
		  ...
		  uniform bool gUsePrecomputedAOMap,
		  ...
		  uniform bool gUseSpecularMap) : SV_Target
{
	...
	if (gUsePrecomputedAOMap)
	{
   	   AOColor = gPrecomputedAOMap.Sample( samLinear, pin.Tex );
	}

	if (gUseSpecularMap)
	{
		SpecColor = gSpecularMap.Sample( samLinear, pin.Tex );
	}
	...
	{  
		...
		float4 ambientAccess = float4(1, 1, 1, 1);
		
	//   if (!gUsePrecomputedAOMap && gUseSSAO)
//	   {
...
technique11 Light0Tex
{
    pass P0
    {
        SetVertexShader( CompileShader( vs_4_0, VS() ) );
		SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, PS(0, true, false, false, false, false, false, false) ) );
    }
}
...
technique11 Light1InstancedTex
{
    pass P0
    {
...
technique11 Light0TexAlphaClip
{
    pass P0
    {
        SetVertexShader( CompileShader( vs_4_0, VS() ) );
		SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, PS(0, true, true, false, false, false, false, false) ) );
    }
}
...
technique11 Light0TexFog
{
    pass P0
    {
        SetVertexShader( CompileShader( vs_4_0, VS() ) );
		SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, PS(0, true, false, true, false, false, false, false) ) );
    }
}
...
technique11 Light0TexAlphaClipFog
{
    pass P0
    {
        SetVertexShader( CompileShader( vs_4_0, VS() ) );
		SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, PS(0, true, true, true, false, false, false, false) ) );
    }
}
...
technique11 Light1Reflect
{
    pass P0
    {
        SetVertexShader( CompileShader( vs_4_0, VS() ) );
		SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, PS(1, false, false, false, true, false, false, false) ));
    }
}
...
technique11 Light2Reflect
{
    pass P0
    {
        SetVertexShader( CompileShader( vs_4_0, VS() ) );
		SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, PS(2, false, false, false, true, false, false, false) ) );
    }
}
...
technique11 Light3Reflect
{
    pass P0
    {
        SetVertexShader( CompileShader( vs_4_0, VS() ) );
		SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, PS(3, false, false, false, true, false, false, false) ) );
    }
}
...
technique11 Light0TexReflect
{
    pass P0
    {
        SetVertexShader( CompileShader( vs_4_0, VS() ) );
		SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, PS(0, true, false, false, true, false, false, false ) ) );
    }
}
...
technique11 Light1TexReflect
{
    pass P0
    {
        SetVertexShader( CompileShader( vs_4_0, VS() ) );
		SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, PS(1, true, false, false, true, false, false, false) ) );
    }
}
...
technique11 Light2TexReflect
{
    pass P0
    {
        SetVertexShader( CompileShader( vs_4_0, VS() ) );
		SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, PS(2, true, false, false, true, false, false, false) ) );
    }
}
...
technique11 Light3TexReflect
{
    pass P0
    {
        SetVertexShader( CompileShader( vs_4_0, VS() ) );
		SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, PS(3, true, false, false, true, false, false, false) ) );
    }
}
...
technique11 Light0TexAlphaClipReflect
{
    pass P0
    {
        SetVertexShader( CompileShader( vs_4_0, VS() ) );
		SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, PS(0, true, true, false, true, false, false, false) ) );
    }
}
...
technique11 Light1TexAlphaClipReflect
{
    pass P0
    {
        SetVertexShader( CompileShader( vs_4_0, VS() ) );
		SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, PS(1, true, true, false, true, false, false, false) ) );
    }
}
...
technique11 Light2TexAlphaClipReflect
{
    pass P0
    {
        SetVertexShader( CompileShader( vs_4_0, VS() ) );
		SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, PS(2, true, true, false, true, false, false, false) ) );
    }
}
...
technique11 Light3TexAlphaClipReflect
{
    pass P0
    {
        SetVertexShader( CompileShader( vs_4_0, VS() ) );
		SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, PS(3, true, true, false, true, false, false, false) ) );
    }
}
...
technique11 Light0TexFogReflect
{
    pass P0
    {
        SetVertexShader( CompileShader( vs_4_0, VS() ) );
		SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, PS(0, true, false, true, true, false, false, false) ) );
    }
}
...
technique11 Light0TexAlphaClipFogReflect
{
    pass P0
    {
        SetVertexShader( CompileShader( vs_4_0, VS() ) );
		SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, PS(0, true, true, true, true, false, false, false) ) );
    }
}
...
//I only defined techniques which were needed by this application at time of writing.

technique11 Light1TexAlphaClipAOMap
{
	pass P0
	{
		SetVertexShader( CompileShader( vs_4_0, VS() ) );
		SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, PS(1, true, true, false, false, true, false, false) ) ); 
	}

}

technique11 Light1TexAOMap
{
	pass P0
	{
		SetVertexShader( CompileShader( vs_4_0, VS() ) );
		SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, PS(1, true, false, false, false, true, false, false) ) ); 
	}

}


technique11 Light1TexAlphaClipSsao
{
	pass P0
	{
		SetVertexShader( CompileShader( vs_4_0, VS() ) );
		SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, PS(1, true, true, false, false, false, true, false) ) ); 
...
technique11 Light1TexSsao
{
	pass P0
	{
		SetVertexShader( CompileShader( vs_4_0, VS() ) );
		SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, PS(1, true, false, false, false, false, true, false) ) ); 
...
technique11 Light1TexAlphaClipAOSpecMap
{
	pass P0
	{
		SetVertexShader( CompileShader( vs_4_0, VS() ) );
		SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, PS(1, true, true, false, false, true, false, true) ) ); 
	}

}

technique11 Light1TexAOSpecMap
{
	pass P0
	{
		SetVertexShader( CompileShader( vs_4_0, VS() ) );
		SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, PS(1, true, false, false, false, true, false, true) ) ); 
	}

}


technique11 Light1TexAlphaClipSpecMap
{
	pass P0
	{
		SetVertexShader( CompileShader( vs_4_0, VS() ) );
		SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, PS(1, true, true, false, false, false, false, true) ) ); 
	}

}

technique11 Light1TexSpecMap
{
	pass P0
	{
		SetVertexShader( CompileShader( vs_4_0, VS() ) );
		SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, PS(1, true, false, false, false, false, false, true) ) ); 
	}
